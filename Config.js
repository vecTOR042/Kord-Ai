global.settings = {
    OWNER_NUMBERS: "2348131679153", // replace with your number
    OWNER_NAME: 'VICTOR', // desired name
    ...
    WORK_MODE: "Public",
    TIME_ZONE: "Africa/Enugu",
    READ_ALL_MESSAGES: false,
    PREFIX: [".", "/", "!"],
    WELCOME_MESSAGE: "Hello! I'm 🤫, your friendly WhatsApp bot.",
